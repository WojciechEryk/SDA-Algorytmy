...
//        temporalAdjusters();
    ...
    private static void dateTimeLocal() {
        ...
        LocalDateTime courseEnd = LocalDateTime.parse("2017-07-18T21:00:01");
    ...
    private static void formatting() {
        ...
        System.out.println(now.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM).withLocale(Locale.UK)));
    }
    ...
    private static void temporalAdjusters() {
        ...
        System.out.println("first Wed " + firstWednesday.toLocalDate());
